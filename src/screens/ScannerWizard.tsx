...
const categories = [
  { id: "flight", emoji: "✈️", en: "Flight Ticket", ar: "تذكرة طيران", color: "#004D5B", paleBg: "#E0F4F5",
    subs: ["One Way", "Round Trip", "Connecting", "Transit Visa", "Other"] },
  ...
  { id: "hotel", emoji: "🏨", en: "Hotel / Stay", ar: "فندق / إقامة", color: "#2A1A35", paleBg: "#EEE8F2",
    subs: ["Hotel", "Apartment", "Hospital", "Private House", "Other"] },
  { id: "legal", emoji: "🛂", en: "Legal Document", ar: "وثيقة قانونية", color: "#1A3A1A", paleBg: "#E8F2E8",
    subs: ["Passport", "National ID", "Visa", "Residency Permit", "Travel Insurance Card", "Other"] },
