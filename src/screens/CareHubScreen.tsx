...
const CareHubScreen = () => {
  ...
  const handleCopyCarePlan = () => {
    ...
    toast.success("Care plan copied<span className="font-arabic" dir="rtl"> · تم نسخ خطة الرعاية</span>"", { duration: 2000 });
  };
  ...
  const handleExportCarePlan = () => {
    ...
    toast.success("Care plan exported<span className="font-arabic" dir="rtl"> · تم تصدير خطة الرعاية</span>"", { duration: 2000 });
  };
            ...
            {isExpanded && (
              <div className="px-4 pb-4">
                ...
                <button onClick={(e) => {
                  ...
                  {isDone ? "✓ Done<span className="font-arabic" dir="rtl"> · تم</span>"" : "Mark as Done<span className="font-arabic" dir="rtl"> · تم</span>""}
                </button>
              </div>
            )}
          </div>
