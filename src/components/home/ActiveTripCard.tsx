    ...
    >
      <div className="flex items-center justify-between mb-1">
        <div className="min-w-0">
          ...
          <p
            className="font-display text-lg mt-0.5 truncate"
      ...
      <div className="grid grid-cols-3 text-center">
        {[
          { val: `${journeyCount}`, sub: journeyLabel, subAr: "رحلات", color: "var(--success)" },
          { val: daysLeft != null ? `${daysLeft}` : "—", sub: "Days Left", subAr: "أيام متبقية", color: "var(--teal-deep)" },
